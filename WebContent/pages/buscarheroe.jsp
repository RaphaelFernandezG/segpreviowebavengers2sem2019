...
<body
	...
	<div class="container">
		...
		<form method="get" action="../BuscarHeroeController">
			<div class="form-row align-items-center">
				<div class="col">
					<label class="sr-only" for="inlineFormInput">Nombre De
						Heroe A Buscar</label> <input type="text" class="form-control mb-2"
						id="heroe" name="heroe"
