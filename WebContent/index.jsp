	...
	<div class="container">
		...
		<div class="row">
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/listarheroes.jsp'">Listar Heroes</button>
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/.jsp'">Registrar Heroe</button>
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/.jsp'">Registrar Peliculas
				Que Ha participado Un Heroe</button>
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/buscarheroe.jsp'">Buscar Heroe</button>
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/.jsp'">Actualizar Heroe</button>
			<button type="submit" class="btn btn-primary btn-lg btn-block"
				onclick="location.href='pages/.jsp'">Eliminar Heroe</button>
